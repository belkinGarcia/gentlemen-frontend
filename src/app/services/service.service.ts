...
const MOCK_SERVICES: Category[] = [
  ...
  },
  {
    category: 'Paquetes',
    items: [
      { id: 301, name: 'Corte + Barba Express', description: 'Corte rápido y perfilado de barba.', price: 80, duration: 70, imageUrl: 'https://i.pinimg.com/736x/87/48/03/8748031d6e694fb31b0ad85bf3e7c849.jpg' },
    ]
  }
];
@Injectable({
