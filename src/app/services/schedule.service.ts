...
import { Service } from './service.service'; // Importamos Service para acceder a .duration

// Horas Abiertas del local (8 AM a 8 PM)
...
export class ScheduleService {
  ...
  getAvailableTimesFor(date: Date, barberId: number | null, appointmentDuration: number): string[] { 
    ...
    // Lógica de Día de Descanso y Modalidad
